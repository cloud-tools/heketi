...
In the [demo](http://github.com/cloud-tools/heketi/wiki/Demo),
...
[client/cli/go/topology-sample.json](https://github.com/cloud-tools/heketi/blob/master/client/cli/go/topology-sample.json)
